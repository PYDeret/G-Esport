...
<body>
                ...
                <div class="col-xs-3 col-md-4">
                  <a href="#" class="angled-img">
                    <div class="img">
                      ...
                      <img src="/images/game-journey-500x375.jpg" alt="">
                    </div>
                  </a>
                </div>
  ...
  <section class="content-wrap">
    ...
    <div class="youplay-carousel" data-autoplay="5000">
      ...
      <a class="angled-img" href="#!">
        <div class="img">
          <img src="/images/game-no-mans-sky-500x375.jpg" alt="">
        </div>
        <div class="over-info">
          <div>
            <div>
      ...
      <a class="angled-img" href="#!">
        <div class="img">
          <img src="/images/game-proteus-500x375.jpg" alt="">
        </div>
        <div class="over-info">
          <div>
            <div>
      ...
      <a class="angled-img" href="#!">
        <div class="img">
          <img src="/images/game-brothers-a-tale-of-two-sons-500x375.jpg" alt="">
        </div>
        <div class="over-info">
          <div>
            <div>
    ...
    <div class="youplay-carousel">
      <a class="angled-img" href="#!">
        <div class="img">
          <img src="/images/game-machinarium-500x375.jpg" alt="">
        </div>
        <div class="over-info">
          <div>
            <div>
      ...
      <a class="angled-img" href="#!">
        <div class="img">
          <img src="/images/game-broken-age-500x375.jpg" alt="">
        </div>
        <div class="over-info">
          <div>
            <div>
      ...
      <a class="angled-img" href="#!">
        <div class="img">
          <img src="/images/game-dream-500x375.jpg" alt="">
        </div>
        <div class="over-info">
          <div>
            <div>
      ...
      <a class="angled-img" href="#!">
        <div class="img">
          <img src="/images/game-world-of-goo-500x375.jpg" alt="">
        </div>
        <div class="over-info">
          <div>
            <div>
    ...
    <footer class="youplay-footer-parallax">
      <div class="wrapper" style="background-image: url('/images/footer-bg.jpg')">
        ...
        <div class="copyright">
          <div class="container">
            <strong>G-Esport</strong> &copy; 2018. All rights reserved
          </div>
        </div>
